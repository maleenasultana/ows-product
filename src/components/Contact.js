  ...
  return (
    <div>
        ...
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animated slideInDown">ContactUs</h1>
        </div>
        </div>
        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p className="mb-0">OneWAsender is the epitome of WhatsApp marketing, a powerful tool to supercharge your business's outreach and engagement. It's more than just software; it's a symbol of success in the world of WhatsApp marketing, helping you connect with your audience, deliver your message, and achieve remarkable results.</p>
                </div>
                <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <h5 className="mb-4">Get In Touch</h5>
                    <p><i className="fa fa-map-marker-alt me-3"></i>one code work, 45, Bhopal, Madhya Pradesh</p>
